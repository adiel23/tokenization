...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in taprootassets_pb2_grpc.py depends on'
...
class TaprootAssetsStub(object):
    ...
    def __init__(self, channel):
        ...
        self.FetchAsset = channel.unary_unary(
                '/taprpc.TaprootAssets/FetchAsset',
                request_serializer=taprootassets__pb2.FetchAssetRequest.SerializeToString,
                response_deserializer=taprootassets__pb2.FetchAssetResponse.FromString,
                _registered_method=True)
        ...
        self.BakeMacaroon = channel.unary_unary(
                ...
                request_serializer=taprootassets__pb2.BakeMacaroonRequest.SerializeToString,
                response_deserializer=taprootassets__pb2.BakeMacaroonResponse.FromString,
                _registered_method=True)
        self.FetchAssetMeta = channel.unary_unary(
                ...
                response_deserializer=taprootassets__pb2.FetchAssetMetaResponse.FromString,
                _registered_method=True)
...
def add_TaprootAssetsServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'FetchAsset': grpc.unary_unary_rpc_method_handler(
                    servicer.FetchAsset,
                    request_deserializer=taprootassets__pb2.FetchAssetRequest.FromString,
                    response_serializer=taprootassets__pb2.FetchAssetResponse.SerializeToString,
            ),
            ...
            'BakeMacaroon': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=taprootassets__pb2.BakeMacaroonRequest.FromString,
                    response_serializer=taprootassets__pb2.BakeMacaroonResponse.SerializeToString,
            ),
            'FetchAssetMeta': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=taprootassets__pb2.FetchAssetMetaResponse.SerializeToString,
            ),
...
class TaprootAssets(object):
    ...
    def FetchAsset(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/taprpc.TaprootAssets/FetchAsset',
            taprootassets__pb2.FetchAssetRequest.SerializeToString,
            taprootassets__pb2.FetchAssetResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def BakeMacaroon(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/taprpc.TaprootAssets/BakeMacaroon',
            taprootassets__pb2.BakeMacaroonRequest.SerializeToString,
            taprootassets__pb2.BakeMacaroonResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def FetchAssetMeta(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            taprootassets__pb2.FetchAssetMetaResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
